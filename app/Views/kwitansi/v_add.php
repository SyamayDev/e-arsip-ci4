<div class="col-md-12">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Tambah Kwitansi</h3>
        </div>
        <div class="card-body">
            <?= form_open('kwitansi/save'); ?>
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="telah_diterima_dari" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Uang Sejumlah (Rp)</label>
                        <input type="number" class="form-control" id="uang_sejumlah" name="uang_sejumlah" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="untuk_keperluan" rows="3" required></textarea>
                    </div>
                </div>
            </div>
